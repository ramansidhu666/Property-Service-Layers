...
namespace Property.Service
{
    public interface IIdxCommercialService
    {
        ...
        List<PropertyModel> GetCommercials(string dbname = "", string userid = "");
        ...
        List<PropertyType> GetPropertyTypes_Comm();
    }
    public class IdxCommercialService : BaseRepository, IIdxCommercialService
    {
        ...
        public List<PropertyModel> GetCommercials(string dbname = "", string userid = "")
        {
            try
            {
        ...
        public List<PropertyType> GetPropertyTypes_Comm()
        {
            ...
            try
            {
                using (IDbConnection _db = OpenConnection())
                {
                    PropertyTypes = _db.Query<PropertyType>("GetPropertyTypes_Comm", commandType: CommandType.StoredProcedure).ToList();
