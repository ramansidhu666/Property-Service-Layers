...
namespace Property.Service
{
    public interface IIdxCondoService
    {
        ...
        List<PropertyModel> GetCondos(string dbname = "", string userid = "");
        ...
        List<PropertyType> GetPropertyTypes_Condo();
    }
    public class IdxCondoService : BaseRepository, IIdxCondoService
    {
        ...
        public List<PropertyModel> GetCondos(string dbname = "", string userid = "")
        {
            try
            {
                using (IDbConnection _db = OpenConnection())
        ...
        public List<PropertyType> GetPropertyTypes_Condo()
        {
            ...
            try
            {
                using (IDbConnection _db = OpenConnection())
                {
                    PropertyTypes = _db.Query<PropertyType>("GetPropertyTypes_Condo", commandType: CommandType.StoredProcedure).ToList();
